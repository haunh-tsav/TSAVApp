...
type BorderBottomRadiusKeys = `roundedBottom_${ArrayValue<typeof config.borders.radius>}`
...
type BorderTopRadiusKeys = `roundedTop_${ArrayValue<typeof config.borders.radius>}`

type BorderWidthBottomKeys = `wBottom_${ArrayValue<typeof config.borders.widths>}`
